# file name: scatter_plots_for_sigma0p94_R01p2.py
...
if __name__ == "__main__":
    ...
    result = analyze_distances(
        ...
        standard_point=(0.02852796, 0.03587762, 0.13819717, 0.13320869),  # Fixed: added commas
        weights=(0.9, 0.1, 0.1, 0.8),  # Fixed: added commas
        metric="euclidean",
        p=3,
        output_path="../../experimental_data/from_260703/dists_sigma0p94_R01p2_recal.csv"
    )
