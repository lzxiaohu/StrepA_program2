# file name: flow_process_sigma0p94_R03p0.py
...
def plot_posetrior_concentration(
    file_dists='../../experimental_data/from_260703/dists_sigma0p94_R03p0_seed1690_recal.csv',
    file_R0='../../experimental_data/from_260703/R0.csv',
    file_sigma='../../experimental_data/from_260703/sigma.csv',
    percentile=1.0,
    ...
    bw_method='silverman',
    title="ABC Posterior",
    save_path='../../figures/from_260703/ppc/sigma0p94/R03p0_seed1690/',
...
def plot_r0_sigma(true_R0, true_sigma, peak_R0s, peak_sigmas,
                   ...
                   save_path='../../figures/from_260703/ppc/sigma0p94/R03p0/', 
...
if __name__ == "__main__":
    ...
    file_dists='../../experimental_data/from_260703/dists_sigma0p94_R03p0'
    # file_dists='../../experimental_data/from_260703/dists_sigma0p94_R03p0_seed1690_recal'
    ...
    for seed_sn in seed_number: 
        ...
        # Step 6: Save results
        output_file = f'../../experimental_data/from_260703/optimal_weights_results_sigma0p94_R03p0_seed{seed_sn}.csv'
        ...
        result = analyze_distances(
            ...
            metric="euclidean",
            p=3,
            output_path=f"../../experimental_data/from_260703/dists_sigma0p94_R03p0_seed{seed_sn}_recal.csv"
        )
    ...
    plot_r0_sigma(true_R0, true_sigma, peak_R0s, peak_sigmas, 
                    ...
                    save_filename='peak_values_plot_sigma0p94_R03p0.png')

save_results_to_csv(true_R0, true_sigma, peak_R0s, peak_sigmas,
                         save_path='../../experimental_data/from_260703/', save_filename='peak_estimates_sigma0p94_R03p0.csv')
